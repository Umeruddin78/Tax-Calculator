This repository contains a simple web-based tax calculation form. Users can input their gross annual income, extra income, age group, and applicable deductions to calculate their tax.
